--------------------------------------------------------------------------------
 ...
 1 ADAMSPrep - ADAMS preprocessor mode {1: Run FAST, 2: use FAST as a preprocessor to create an ADAMS model, 3: do
 ...
 9999.9 TPitManE(1) - Time to start override pitch maneuver for blade 1 and end standard pitch control (s)
 9999.9 TPitManE(2) - Time to start override pitch maneuver for blade 2 and end standard pitch control (s)
 9999.9 TPitManE(3) - Time to start override pitch maneuver for blade 3 and end standard pitch control (s) [unused for 2
 ...
 90.0 BlPitchF(1) - Blade 1 final pitch for override pitch maneuvers (degrees)
 90.0 BlPitchF(2) - Blade 2 final pitch for override pitch maneuvers (degrees)
 90.0 BlPitchF(3) - Blade 3 final pitch for override pitch maneuvers (degrees) [unused for 2 blades]
 ...
 "AWT_Blades.dat" BldFile(3) - Name of file containing properties for blade 3 (quoted string)
 ---------------------- AERODYN -------------------------------------------------
 "Test01_AD.ipt" ADFile - Name of file containing AeroDyn input parameters (quoted strin
 ---------------------- NOISE ---------------------------------------------------
        NoiseFile - Name of file containing aerodynamic noise input parameters (quoted string) [used only when CompNois
 ---------------------- ADAMS ---------------------------------------------------
 "AWT_ADAMS.dat" ADAMSFile - Name of file containing ADAMS-specific input parameters (quote
 ---------------------- LINEARIZATION CONTROL -----------------------------------
 "AWT_Linear.dat" LinFile - Name of file containing FAST linearization parameters (quoted
---------------------- OUTPUT --------------------------------------------------
...
"TipDxc2,TipDxb2,TipDyb2"       - Blade 2 flapwise and edgewise tip deflections
