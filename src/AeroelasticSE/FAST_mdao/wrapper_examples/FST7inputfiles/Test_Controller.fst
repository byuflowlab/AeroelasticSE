...
---------------------- TURBINE CONTROL -----------------------------------------
   1        YCMode      - Yaw control mode {0: none, 1: user-defined from routine UserYawCont, 2: user-defined from Simulink/Labview} (switch)
...
9999.9      TimGenOf    - Time to turn off the generator (s) [used only when GenTiStp=True]
   2        HSSBrMode   - HSS brake model {1: simple, 2: user-defined from routine UserHSSBr, 3: user-defined from Labview} (switch)
